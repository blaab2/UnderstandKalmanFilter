function B = lstm1_getContinuousB(I_zz,c_alpha_fl,c_alpha_fr,c_alpha_rl,c_alpha_rr,l_f,l_r,m,v)
%LSTM1_GETCONTINUOUSB
...
% 
t2 = 1.0./I_zz;
t3 = c_alpha_fl+c_alpha_fr;
t4 = 1.0./m;
t5 = 1.0./v;
t6 = c_alpha_rl+c_alpha_rr;
B = reshape([l_f.*t2.*t3,t3.*t4.*t5,-l_r.*t2.*t6,t4.*t5.*t6,t2,0.0],[2,3]);
